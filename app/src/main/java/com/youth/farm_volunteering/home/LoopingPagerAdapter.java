...
public abstract class LoopingPagerAdapter<T> extends PagerAdapter {
    ...
    protected List<AdData> itemList;
    ...
    public LoopingPagerAdapter(Context context, List<AdData> itemList, boolean isInfinite) {
        this.context = context;
        this.isInfinite = isInfinite;
        setItemList(itemList);
    }

    public void setItemList(List<AdData> itemList) {
    ...
    public AdData getItem(int listPosition) {
