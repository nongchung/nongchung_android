...
//
//        var getProfile = ApplicationController.instance!!.networkService!!.farmprofile(nhIdx.getRealId()!!)
//        getProfile.enqueue(object : Callback<FarmProfileResponseData> {
...
//                Log.d("name",response!!.body().farmerInfo!!.farmName)
//            }
//        })
